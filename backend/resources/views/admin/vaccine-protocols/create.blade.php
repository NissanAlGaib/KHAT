...
@section('title', 'Create Vaccine Protocol - KHAT Admin')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 lg:p-8 max-w-3xl">
    <form action="{{ route('admin.vaccine-protocols.store') }}" method="POST">
        @csrf

        <!-- Name -->
        <div class="mb-6">
            <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">Protocol Name <span class="text-red-500">*</span></label>
            <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g., Rabies, DHPP, FVRCP" class="w-full bg-white border border-gray-300 text-gray-700 py-2.5 px-4 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#E75234] focus:border-transparent transition">
            @error('name')
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                <select name="species" id="species" required class="w-full appearance-none bg-white border border-gray-300 text-gray-700 py-2.5 px-4 pr-10 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#E75234] focus:border-transparent transition">
                    ...
                    <option value="all" {{ old('species') == 'all' ? 'selected' : '' }}>All Species</option>
                </select>
        ...
        <div class="mb-6">
            <label class="flex items-center gap-3 cursor-pointer">
                ...
                <input type="checkbox" name="is_required" value="1" {{ old('is_required') ? 'checked' : '' }} class="w-5 h-5 rounded border-gray-300 text-[#E75234] focus:ring-[#E75234] transition">
        ...
        <div class="mb-6">
            ...
            <textarea name="description" id="description" rows="3" placeholder="Brief description of this vaccine protocol..." class="w-full bg-white border border-gray-300 text-gray-700 py-2.5 px-4 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#E75234] focus:border-transparent transition resize-none">{{ old('description') }}</textarea>
            @error('description')
                <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="space-y-3">
                <label class="flex items-start gap-3 p-4 rounded-lg border border-gray-200 cursor-pointer hover:border-[#E75234] hover:bg-[#FDF4F2] transition-colors protocol-type-label">
                    <input type="radio" name="protocol_type" value="series_only" {{ old('protocol_type', 'series_only') == 'series_only' ? 'checked' : '' }} class="mt-0.5 w-4 h-4 text-[#E75234] focus:ring-[#E75234] border-gray-300">
                    <div>
                ...
                <label class="flex items-start gap-3 p-4 rounded-lg border border-gray-200 cursor-pointer hover:border-[#E75234] hover:bg-[#FDF4F2] transition-colors protocol-type-label">
                    <input type="radio" name="protocol_type" value="series_with_booster" {{ old('protocol_type') == 'series_with_booster' ? 'checked' : '' }} class="mt-0.5 w-4 h-4 text-[#E75234] focus:ring-[#E75234] border-gray-300">
                    <div>
                ...
                <label class="flex items-start gap-3 p-4 rounded-lg border border-gray-200 cursor-pointer hover:border-[#E75234] hover:bg-[#FDF4F2] transition-colors protocol-type-label">
                    <input type="radio" name="protocol_type" value="recurring" {{ old('protocol_type') == 'recurring' ? 'checked' : '' }} class="mt-0.5 w-4 h-4 text-[#E75234] focus:ring-[#E75234] border-gray-300">
                    <div>
        ...
        <div id="series-fields" class="mb-6 p-5 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="series_doses" id="series_doses" value="{{ old('series_doses', 1) }}" min="1" max="10" class="w-full bg-white border border-gray-300 text-gray-700 py-2.5 px-4 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#E75234] focus:border-transparent transition">
                    @error('series_doses')
                        <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" name="series_interval_days" id="series_interval_days" value="{{ old('series_interval_days') }}" min="1" placeholder="e.g., 21" class="w-full bg-white border border-gray-300 text-gray-700 py-2.5 px-4 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#E75234] focus:border-transparent transition">
        ...
        <div id="booster-fields" class="mb-6 p-5 bg-gray-50 rounded-lg border border-gray-200 hidden">
            ...
            <div>
                ...
                <input type="number" name="booster_interval_days" id="booster_interval_days" value="{{ old('booster_interval_days') }}" min="1" placeholder="e.g., 365 for annual" class="w-full bg-white border border-gray-300 text-gray-700 py-2.5 px-4 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#E75234] focus:border-transparent transition">
        ...
        <div class="mb-8">
            ...
            <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', 0) }}" min="0" class="w-full sm:w-32 bg-white border border-gray-300 text-gray-700 py-2.5 px-4 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#E75234] focus:border-transparent transition">
