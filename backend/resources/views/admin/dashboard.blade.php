...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
    <!-- Card 1: Total Users -->
    <div onclick="openStatsDetail('total_users')" class="bg-white p-5 rounded-xl shadow-sm border border-gray-50 hover:shadow-md transition-all cursor-pointer group">
        ...
        @if($hasDateFilter && $filteredUsers !== null)
        <p class="text-xs text-blue-500 font-semibold mt-1">{{ $filteredUsers }} in selected period</p>
        @endif
    </div>
    <!-- Card 2: Verified Breeders -->
    <div onclick="openStatsDetail('verified_breeders')" class="bg-white p-5 rounded-xl shadow-sm border border-gray-50 hover:shadow-md transition-all cursor-pointer group">
        <div class="flex justify-between items-start mb-2">
            <span class="text-sm font-semibold text-gray-500">Verified Breeders</span>
            <div class="w-10 h-10 rounded-lg bg-green-100 flex items-center justify-center group-hover:scale-110 transition-transform"><i data-lucide="check-circle" class="w-5 h-5 text-green-600"></i></div>
        </div>
        ...
        @if($hasDateFilter && $filteredBreeders !== null)
        <p class="text-xs text-blue-500 font-semibold mt-1">{{ $filteredBreeders }} in selected period</p>
        @endif
    </div>
    <!-- Card 3: Verified Shooters -->
    <div onclick="openStatsDetail('verified_shooters')" class="bg-white p-5 rounded-xl shadow-sm border border-gray-50 hover:shadow-md transition-all cursor-pointer group">
        <div class="flex justify-between items-start mb-2">
            <span class="text-sm font-semibold text-gray-500">Verified Shooters</span>
            <div class="w-10 h-10 rounded-lg bg-emerald-100 flex items-center justify-center group-hover:scale-110 transition-transform"><i data-lucide="shield-check" class="w-5 h-5 text-emerald-600"></i></div>
        </div>
        ...
        @if($hasDateFilter && $filteredShooters !== null)
        <p class="text-xs text-blue-500 font-semibold mt-1">{{ $filteredShooters }} in selected period</p>
        @endif
    </div>
    <!-- Card 4: Active Pets -->
    <div onclick="openStatsDetail('active_pets')" class="bg-white p-5 rounded-xl shadow-sm border border-gray-50 hover:shadow-md transition-all cursor-pointer group">
        <div class="flex justify-between items-start mb-2">
            <span class="text-sm font-semibold text-gray-500">Active Pets</span>
            <div class="w-10 h-10 rounded-lg bg-amber-100 flex items-center justify-center group-hover:scale-110 transition-transform"><i data-lucide="paw-print" class="w-5 h-5 text-amber-600"></i></div>
        </div>
        ...
        @if($hasDateFilter && $filteredActivePets !== null)
        <p class="text-xs text-blue-500 font-semibold mt-1">{{ $filteredActivePets }} in selected period</p>
        @endif
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
    ...
    <div onclick="openStatsDetail('disabled_pets')" class="bg-white p-5 rounded-xl shadow-sm border border-gray-50 hover:shadow-md transition-all cursor-pointer group">
        <div class="flex justify-between items-start mb-2">
            <span class="text-sm font-semibold text-gray-500">Disabled Pets</span>
            <div class="w-10 h-10 rounded-lg bg-red-100 flex items-center justify-center group-hover:scale-110 transition-transform"><i data-lucide="shield-off" class="w-5 h-5 text-red-600"></i></div>
        </div>
        ...
        @if($hasDateFilter && $filteredDisabledPets !== null)
        <p class="text-xs text-blue-500 font-semibold mt-1">{{ $filteredDisabledPets }} in selected period</p>
        @endif
    </div>
    <!-- Card 6: Cooldown Pets -->
    <div onclick="openStatsDetail('cooldown_pets')" class="bg-white p-5 rounded-xl shadow-sm border border-gray-50 hover:shadow-md transition-all cursor-pointer group">
        <div class="flex justify-between items-start mb-2">
            <span class="text-sm font-semibold text-gray-500">Cooldown Pets</span>
            <div class="w-10 h-10 rounded-lg bg-sky-100 flex items-center justify-center group-hover:scale-110 transition-transform"><i data-lucide="clock" class="w-5 h-5 text-sky-600"></i></div>
        </div>
    ...
    <div onclick="openStatsDetail('standard_subscribers')" class="bg-white p-5 rounded-xl shadow-sm border border-gray-50 hover:shadow-md transition-all cursor-pointer group">
        <div class="flex justify-between items-start mb-2">
            <span class="text-sm font-semibold text-gray-500">Standard Subscribers</span>
            <div class="w-10 h-10 rounded-lg bg-purple-100 flex items-center justify-center group-hover:scale-110 transition-transform"><i data-lucide="user" class="w-5 h-5 text-purple-600"></i></div>
        </div>
        ...
        @if($hasDateFilter && $filteredStandard !== null)
        <p class="text-xs text-blue-500 font-semibold mt-1">{{ $filteredStandard }} in selected period</p>
        @endif
    </div>
    <!-- Card 8: Premium Subscribers -->
    <div onclick="openStatsDetail('premium_subscribers')" class="bg-white p-5 rounded-xl shadow-sm border border-gray-50 hover:shadow-md transition-all cursor-pointer group">
        <div class="flex justify-between items-start mb-2">
            <span class="text-sm font-semibold text-gray-500">Premium Subscribers</span>
            <div class="w-10 h-10 rounded-lg bg-orange-100 flex items-center justify-center group-hover:scale-110 transition-transform"><i data-lucide="crown" class="w-5 h-5 text-orange-600"></i></div>
        </div>
        ...
        @if($hasDateFilter && $filteredPremium !== null)
        <p class="text-xs text-blue-500 font-semibold mt-1">{{ $filteredPremium }} in selected period</p>
        @endif
    </div>
</div>
...
<script>
    ...
    const freeUsers = @json(max(0, $totalUsers - $standardSubscribers - $premiumSubscribers));
    const standardUsers = @json((int) $standardSubscribers);
    const premiumUsers = @json((int) $premiumSubscribers);
