...
| ------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.5.0   | 2026-02-18 | Payment & Transaction Pooling: virtual money pool ledger, dispute handling, admin dashboard, API endpoints, frontend "My Payments" screen, and tests. |
